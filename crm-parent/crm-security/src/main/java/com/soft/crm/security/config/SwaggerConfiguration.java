...
public class SwaggerConfiguration {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.soft.crm"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .termsOfServiceUrl("https://github.com/poicc")
                .version("1.0.0")
                .contact(new Contact("crq", "https://github.com/poicc", "2631315464@qq.com"))
                .build();
    }
